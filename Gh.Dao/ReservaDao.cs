...
namespace Gh.Dao
{
    public class ReservaDao : BaseDao<ReservaDto>, IDao<ReservaDto>
    {
        public ReservaDto Add(ReservaDto reserva)
        {
            ...
            fechaInicioParameter.Value = reserva.FechaInicio.ToString("yyyy-MM-dd HH:mm:ss");
            ...
            fechaFinalParameter.Value = reserva.FechaFinal.ToString("yyyy-MM-dd HH:mm:ss");
            ...
            fechaReservaParameter.Value = reserva.FechaReserva.ToString("yyyy-MM-dd HH:mm:ss");
